...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{SNR_medium_2_15.png}
  \includegraphics[width=0.8\textwidth]{SNR_medium_1_30.png}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{sigmac_medium_2_15.png}
  \includegraphics[width=0.8\textwidth]{sigmac_medium_1_30.png}
